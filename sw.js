const CACHE='prepa-futsal-v6-4-1-copy-warmup-physio-20260816';
const ASSETS=['./','./index.html','./styles.css?v=20260816-v641','./data.js?v=20260816-v641','./app.js?v=20260816-v641','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
